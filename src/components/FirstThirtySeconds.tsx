...
export const FirstThirtySeconds: React.FC<FirstThirtySecondsProps> = ({ onNavigate }) => {
  ...
  const items = [
    ...
    },
    {
      ...
      detail: 'mkdir my-app && composer require flintphp/framework',
      isCode: true,
    ...
    },
    {
      ...
      summary: 'Inspect the vendor/bin/flint console utility or start the PHP development server.',
      detail: 'vendor/bin/flint',
      isCode: true,
      code: 'vendor/bin/flint\nphp -S localhost:8000 -t public',
      icon: FileCode2,
      badge: 'Workflow',
