...
export const FirstThirtySeconds: React.FC<FirstThirtySecondsProps> = ({ onNavigate }) => {
  ...
  const items = [
    ...
    },
    {
      ...
      summary: 'One standard Composer command creates your application skeleton.',
    ...
    },
    {
      ...
      summary: 'Enter directory and inspect bin/flint commands or start development server.',
      detail: 'cd my-app && php bin/flint',
      isCode: true,
      code: 'cd my-app\nphp bin/flint',
      icon: FileCode2,
      badge: 'Workflow',
    ...
    },
    {
      ...
      detail: `$router->get('/api/users', fn(ServerRequest $req): Response => Response::json($users));`,
      isCode: true,
      code: `$router->get('/api/hello', function (ServerRequest $request): Response {\n    return Response::json(['message' => 'Hello from FlintPHP']);\n});`,
      icon: Code2,
      badge: 'First Route',
