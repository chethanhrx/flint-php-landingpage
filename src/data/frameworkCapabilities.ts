...
export const CAPABILITY_GROUPS: CapabilityGroup[] = [
  {
    ...
    items: [
      ...
      { name: 'Exception Handling', description: 'Centralized, format-aware error handling producing JSON error responses.', docPath: '/docs/core/kernel', status: 'Stable' },
    ],
  },
  {
    id: 'application',
  ...
  },
  {
    ...
    items: [
      { name: 'Authentication', description: 'Pluggable bearer token authenticator with secure password hashing.', docPath: '/docs/security/authentication', status: 'Stable' },
      ...
      { name: 'Security Headers', description: 'Basic configurable security headers middleware.', docPath: '/docs/security/security-headers', status: 'Stable' },
      { name: 'Trusted Proxy Support', description: 'Strict IP/CIDR verification for reverse proxies and load balancers.', docPath: '/docs/security/trusted-proxies', status: 'Deferred' },
    ],
  },
  {
    id: 'infrastructure',
  ...
  },
  {
    ...
    items: [
      { name: 'CLI Tooling (bin/flint)', description: 'Foundation for building custom console commands.', docPath: '/docs/developer-tools/cli', status: 'Foundation' },
      { name: 'Testing Suite', description: 'Basic testing utilities and Foundation TestCase base classes.', docPath: '/docs/developer-tools/testing', status: 'Foundation' },
